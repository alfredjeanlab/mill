...
struct StateMachineInner {
    ...
    current_snapshot: Option<config::Snapshot>,
    version: u64,
}
...
impl StateMachineStore {
    ...
    pub fn from_snapshot(
        ...
        let inner = StateMachineInner {
            ...
            current_snapshot: Some(config::Snapshot {
                meta,
...
impl openraft::storage::RaftStateMachine<TypeConfig> for StateMachineStore {
    ...
    async fn install_snapshot(
        ...
        let version = {
            ...
            inner.current_snapshot = Some(config::Snapshot {
                meta: meta.clone(),
    ...
    async fn get_current_snapshot(
        ...
        let inner = self.state.read();
        // Clone the snapshot if it exists
